...
class Race {
  ...
  updateStatus(raceId, newStatus) {
    ...
    const allowedTransitions = {
      ...
      [RACE_STATUS.READY]: [RACE_STATUS.ACTIVE, RACE_STATUS.CANCELLED, RACE_STATUS.DRAFT],
      [RACE_STATUS.ACTIVE]: [RACE_STATUS.FINISHED, RACE_STATUS.PAUSED, RACE_STATUS.CANCELLED],
      [RACE_STATUS.PAUSED]: [RACE_STATUS.ACTIVE, RACE_STATUS.FINISHED, RACE_STATUS.CANCELLED, RACE_STATUS.DRAFT],
      [RACE_STATUS.FINISHED]: [RACE_STATUS.CANCELLED], // Une course terminée peut être annulée
