  ...
  return (
    <div className="timing-control-panel">
      ...
      <div className="control-section">
        ...
        >
          <h4>📊 Statuts</h4>
          <i className={`fas fa-chevron-down expand-icon ${expandedSections.status ? 'expanded' : ''}`}></i>
        </div>
      ...
      <div className="control-section">
        ...
        >
          ...
          <i className={`fas fa-chevron-down expand-icon ${expandedSections.race ? 'expanded' : ''}`}></i>
        </div>
      ...
      <div className="control-section">
        ...
        >
          <h4>🎮 Actions</h4>
          <i className={`fas fa-chevron-down expand-icon ${expandedSections.actions ? 'expanded' : ''}`}></i>
        </div>
